  ...
  const recentNotes = [
    {
      ...
      patient: "Riya Sharma",
      date: "2024-03-19",
      treatment: "Tooth Sensitivity Treatment",
      notes: "Applied desensitizing gel. Patient reported immediate relief. Recommended fluoride toothpaste.",
      followUp: "2024-04-02",
      status: "completed"
    },
    {
      ...
      patient: "John Doe",
      date: "2024-03-18",
      treatment: "Root Canal - Session 1",
      notes: "Started root canal procedure on tooth #30. Removed infected pulp. Patient tolerated procedure well.",
      followUp: "2024-03-25",
      status: "ongoing"
    },
    {
      ...
      notes: "Thorough cleaning performed. No cavities detected. Gums are healthy. Continue regular oral hygiene.",
      followUp: "2024-09-15",
      status: "completed"
    }
  ];
