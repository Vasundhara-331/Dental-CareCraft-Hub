  ...
  const appointments = [
    {
      ...
      status: "completed",
      tooth: "UR6",
      notes: "Routine cleaning completed. Minor cavity filled in upper right molar.",
      prescription: "Fluoride rinse, twice daily",
      cost: 1500
    },
    {
      id: 2,
      ...
      status: "completed",
      tooth: "All",
      notes: "Deep cleaning performed. Gums slightly inflamed, recommended better flossing routine.",
    ...
    },
    {
      ...
      status: "completed",
      tooth: "LR7",
      notes: "Wisdom tooth extraction consultation. Scheduled for next month.",
